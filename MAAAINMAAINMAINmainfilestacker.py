...
# If the stacked newly stacked block is only partially aligned with previous blocks, 
# the misaligned portion of blocks will disappear and the user will be stacking with a smaller block than before; increases the difficulty for future stacking.

# Additional feautures: miscelleaneous powerups, music, sound effects, highscore tracker
...
while screen == "newGame":
    ...
    if ending == "win":  # screen if you win (only for classic mode)
        ...
        youWin = Image(Point(250, 250), "youWin.gif")
        ...
        gameOver = Image(Point(250, 250), "gameOver.gif")
        ...
        highscoreBackground = Image(Point(250, 250), "highscoreBackground.gif")
        highscoreBackground.draw(winScreen)
        finalText = Image(Point(250, 50), "finalText.gif")
        ...
        newGameText = Image(Point(250, 220), "newGameText.gif")
        newGameText.draw(winScreen)

        exitGameText = Image(Point(250, 270), "exitGameText.gif")
    ...
    titleBackground = Image(Point(300, 300), "titleBackground.gif")
    titleBackground.draw(titleScreen)
    stackerTitle = Image(Point(300, 75), "stackerTitle.gif")
    stackerTitle.draw(titleScreen)

    classic = Image(Point(300, 230), "classic.gif")
    classic.draw(titleScreen)
    # dimension of image: 300 x 30

    endless = Image(Point(300, 285), "endless.gif")
    endless.draw(titleScreen)

    hotkeyTitle = Image(Point(300, 400), "hotkeyTitle.gif")
    hotkeyTitle.draw(titleScreen)

    rules = Image(Point(300, 447), "rules.gif")
    ...
    highscoreimg = Image(Point(300, 525), "highscore.gif")
    ...
    while screen == "title":
        ...
        if 450 >= click.getX() >= 150 and 245 >= click.getY() >= 215:  # if user clicks on classic
            ...
            if endless:  # gameScreen will be bigger if endless mode is chosen
                ...
                endlessBackground = Image(Point(600, 450), "endlessBackground.gif")
                ...
                classicBackground = Image(Point(450, 450), "classicBackground.gif")
            ...
            while stacking:
                if bop == 5:
                    ...
                    # without a power up, this will set power ups to true when it is 5
                    # this counter will only start when you use a power up, so you
                    # can save power ups for future levels
                    powerupping = True
                    bop = 0
                ...
                # when appropriate (when you stack 5 blocks after using the power ups)
                if endless:
                    if powerupping:
            ...
            hotkeyBackground = Image(Point(250, 250), "hotkeyBackground.gif")
            ...
            changeKey = Image(Point(250, 275), "hotkeyText1.gif")
            changeKey.draw(hotkeyScreen)

            confirmChange = Image(Point(250, 325), "hotkeyText2.gif")
            ...
            while screen == "hotkey fix":
                ...
                if 395 >= click.getX() >= 105 and 292 >= click.getY() >= 258:  # if user chooses to change hotkey
                    changeKey.undraw()
                    selectKey = Image(Point(250, 275), "hotkeyText3.gif")
            ...
            rulesscreenBackground = Image(Point(250, 250), "rulesBackground.gif")
            ...
            # visuals
            aboutscreenBackground = Image(Point(250, 250), "aboutBackground.gif")
            ...
            eggText = Image(Point(50, 450), "eastereggsmall.gif")
            ...
            if easteregg:  # if you click on the easteregg
                ...
                egg = Image(Point(200, 110), "easteregg.gif")
                egg.draw(easterwin)

                smiley1 = Image(Point(75, 350), "smiley.gif")
                smiley2 = Image(Point(325, 350), "smiley.gif")
